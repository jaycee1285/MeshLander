...
<div class="divide-y divide-primary rounded-xl border border-primary bg-base-100">
    <details class="group p-6 [&_summary::-webkit-details-marker]:hidden" open>
      <summary class="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
        <h2 class="text-xl font-medium font-raleway">Lorem ipsum dolor sit amet consectetur adipisicing?</h2>
      ...
      <p class="mt-4 leading-relaxed text-gray-700 font-overpass">
